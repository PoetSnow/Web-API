...
function PayMethod() {
    ...
    var payAmount = $("#totalAmount").val();    //付款金额
    var billId = $("#BillId").val();    //客账Id
    var tabId = $("#Tabid").val();
    var refeId = $("#RefeId").val();
    //暂时没有手牌。 餐饮如果有用到 需要传递keyId
    window.location.href = "/PayMethod/Index?billId=" + billId + "&amount=" + payAmount + "&refeId=" + refeId + "&tabId=" + tabId;
    //跳转到付款方式界面
}